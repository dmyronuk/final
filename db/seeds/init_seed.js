...
exports.seed = function (knex, Promise) {
  ...
  function insertNeighbourhoods() {
    return knex('neighbourhoods').insert(neighbourhoods)
      .returning("*")
  }
  ...
  function insertListings(landlords, neighbourhoods) {
    return knex("listings").insert([{
        ...
        neighbourhoods_id: neighbourhoods[76].id,
  ...
  function insertListingSpecifications(listings) {
    return knex("listing_specifications").insert([{
        bedrooms: 5,
        bathrooms: 3,
        description: descriptions.text[0],
      ...
      },
      {
        ...
        description: descriptions.text[1],
        date_available: new Date("2019 02 19 15:45"),
      ...
      },
      {
        bedrooms: numberBedroomsGen(),
        bathrooms: numberBathroomsGen(),
        description: descriptions.text[2],
        date_available: new Date("2019 02 19 15:45"),
      ...
      },
      {
        bedrooms: numberBedroomsGen(),
        bathrooms: numberBathroomsGen(),
        description: descriptions.text[3],
        date_available: new Date("2019 02 19 15:45"),
      ...
      },
      {
        bedrooms: numberBedroomsGen(),
        bathrooms: numberBathroomsGen(),
        description: descriptions.text[4],
        date_available: new Date("2019 02 19 15:45"),
      ...
      },
      {
        bedrooms: numberBedroomsGen(),
        bathrooms: numberBathroomsGen(),
        description: descriptions.text[5],
        date_available: new Date("2019 02 19 15:45"),
      ...
      },
      {
        bedrooms: numberBedroomsGen(),
        bathrooms: numberBathroomsGen(),
        description: descriptions.text[6],
        date_available: new Date("2019 02 19 15:45"),
      ...
      },
      {
        bedrooms: numberBedroomsGen(),
        bathrooms: numberBathroomsGen(),
        description: descriptions.text[7],
        date_available: new Date("2019 02 19 15:45"),
      ...
      },
      {
        bedrooms: numberBedroomsGen(),
        bathrooms: numberBathroomsGen(),
        description: descriptions.text[8],
        date_available: new Date("2019 02 19 15:45"),
      ...
      },
      {
        bedrooms: numberBedroomsGen(),
        bathrooms: numberBathroomsGen(),
        description: descriptions.text[9],
        date_available: new Date("2019 02 19 15:45"),
      ...
      },
      {
        bedrooms: numberBedroomsGen(),
        bathrooms: numberBathroomsGen(),
        description: descriptions.text[10],
        date_available: new Date("2019 02 19 15:45"),
      ...
      },
      {
        bedrooms: numberBedroomsGen(),
        bathrooms: numberBathroomsGen(),
        description: descriptions.text[11],
        date_available: new Date("2019 02 19 15:45"),
